    ...
    <div className="mx-auto w-full max-w-[1100px] rounded-[28px] border border-[#4e5ca5]/50 bg-[#25336f]/85 p-6 text-white shadow-[0_30px_90px_rgba(8,16,52,0.55)] backdrop-blur-sm md:p-8">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm font-semibold text-[#b8c1f0]">Bey360 ekibine başvurunuzu iletin, ekibimiz size hızlıca dönüş yapsın.</p>
        </div>
        <Link
          href="/giris"
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder="Örn: Bey360 Marketçilik A.Ş."
              required
            />
          </div>
          <div>
